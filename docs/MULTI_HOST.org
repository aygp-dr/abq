...
#+begin_example
host-a (FreeBSD 15)          host-b (FreeBSD 14)
┌─────────────────┐        ┌─────────────────┐
│ ~/.abq/         │   ?    │ ~/.abq/         │
│   channels/     │ ────── │   channels/     │
│     reports/    │        │     reports/    │
...
uv run abq send reports signal '{"signal": "freebsd15_test", ...}'
...
#+begin_src bash
abq-remote $REMOTE_HOST reports signal '{"test": "passed", "host": "host-a"}'
#+end_src
