...
| Cross-machine | No | Yes (host-a ↔ host-b via SCP) |
| Kafka instances | 0 | 0 |
| 3 AM pages | 0 | 0 |
...
| beads | =bd create "hey host-a, tests passed"= | probably sufficient |
| Slack DM | "yo tests passed" | honestly? |

** New Architecture Diagram

#+begin_example
host-a$ scp msg.json $REMOTE_HOST:~/.abq/channels/x/requests/
#+end_example
