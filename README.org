...
[[https://img.shields.io/badge/status-experimental-orange][https://img.shields.io/badge/status-experimental-orange]]
[[https://github.com/aygp-dr/abq/actions/workflows/ci.yml][https://img.shields.io/github/actions/workflow/status/aygp-dr/abq/ci.yml?branch=main&label=CI]]
[[https://codecov.io/gh/aygp-dr/abq][https://img.shields.io/codecov/c/github/aygp-dr/abq]]
[[https://pypi.org/project/abq/][https://img.shields.io/pypi/v/abq]]
[[https://pypi.org/project/abq/][https://img.shields.io/pypi/pyversions/abq]]
[[https://github.com/aygp-dr/abq/blob/main/LICENSE][https://img.shields.io/github/license/aygp-dr/abq]]
...
*Topics:* =ai-agents= =message-queue= =filesystem= =ipc= =actor-model= =python= =cli= =multi-agent= =coordination= =devtools=
...
The =abqbroadcast= channel provides topic-based pub/sub. Content filtering happens in handlers.
